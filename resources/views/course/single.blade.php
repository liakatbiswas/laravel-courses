                ...
                <div class="mt-2 w-2/3 border-gray-100 border-r pr-10 pb-0 border-b-0">
                    ...
                    <div class="flex items-center gap-3 mt-5">
                        ...
                        <a href="#reviews" class="text-sm text-gray-500">
                            ...
                            Review{{ count($course->reviews)>1 ?"s":"" }}
                        </a>
                    </div>
                    <ul class="flex flex-wrap items-center gap-4 mt-5 text-gray-700">
                        ...
                        <li class="flex items-center gap-2">
                            ...
                            <span> {{ $course->dificulty_lavel($course->dificulty_lavel) }}</span>
                        </li>
                        <li class="flex items-center gap-2">
                    ...
                    <h2 class="mt-4 pt-4 text-lg font-bold text-gray-900">
                        Reviews
                    </h2>

                    @if (count($course->reviews)>0)
                    @foreach ($course->reviews as $review )
                    <div class="mb-6 bg-gray-300 p-4">
                        <div class="mb-2">
