...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <footer class="bg-dark pt-[94px] relative">
            ...
            <div class="container flex justify-between pb-[50px]">
                ...
                <div>
                    ...
                    <ul class="mt-5">
                        ...
                        <li class="mb-2">
                            <a href="{{ route('archive',['series','jquery'])}}"
                                class="text-links text-gray-100 text-base before:text-gray-100">jQuery</a>
                        </li>
                    </ul>
                </div>
                <!-- Course by Duration -->
                    ...
                    <ul class="mt-5">
                        <li class="mb-2">
                            <a href="{{ route('archive',['duration','1-5-hours'])}}"
                                class="text-links text-gray-100 text-base before:text-gray-100">1-5
                                hours</a>
                        </li>
                        <li class="mb-2">
                            <a href="{{ route('archive',['duration','5-10-hours'])}}"
                                class="text-links text-gray-100 text-base before:text-gray-100">5-10
                                hours</a>
                        </li>
                        <li class="mb-2">
                            <a href="{{ route('archive',['duration','10-plus-hours'])}}"
                                class="text-links text-gray-100 text-base before:text-gray-100">10+
                                hours</a>
                        </li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul class="mt-5">
                        ...
                        <li class="mb-2">
                            <a href="{{ route('archive',['platform','laravel-news'])}}"
                                class="text-links text-gray-100 text-base before:text-gray-100">Laravel News</a>
                        </li>
                        <li class="mb-2">
                            <a href="{{ route('archive',['platform','laracast-forum'])}}"
                                class="text-links text-gray-100 text-base before:text-gray-100">Laracast Forum</a>
                        </li>
                    </ul>
                </div>
                <!-- Course by Topics -->
                <div>
                    ...
                    <ul class="mt-5">
                        ...
                        <li class="mb-2">
                            <a href="{{ route('archive',['topic','authentication'])}}"
                                class="text-links text-gray-100 text-base before:text-gray-100">Authentication</a>
                        </li>
                        <li class="mb-2">
            ...
            <!--footer bottom -->
            <div class="mx-auto flex items-center justify-between gap-5 pb-8">
